...
<div class="pace-activity"></div></div>
	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-two-sidebar page-with-footer in">
		...
		<div id="content" class="content">
			...
			<!-- begin page-header -->
			<div id="result"></div>
			<h1 class="page-header"><?=$name?>, Add a new Admin! <small>Be mindful of the passwords you use!</small></h1>
			<h4>Admin Name:</h4>
			<input class="form-control" placeholder="Enter Name..." id="name" type="text"><br/>
			<!-- end page-header -->
			
            <!-- begin panel -->
    <div class="form-group">
        <label>Email:</label>
        <input class="form-control" placeholder="Enter Email..." id="email" type="text"><br/>
    </div>
    <div class="form-group">
