                  ...
                  <td>
                    <div class="media">
                      ...
                      <div class="media-body">
                        <a href="http://simpleqode.com/preview/beatrix/1.0.1/blue-grey/shopping-cart.html#">Beautiful Seashell from the Caribbean Sea</a>
                      </div>
                    </div>
                  </td>
                  <td>Free</td>
                  <td>
                    <form class="form-inline">
                      <div class="form-group">
                        ...
                        <input type="number" id="product__quantity_1" value="1" class="form-control shopping-cart__qty">
                      </div>
                    </form>
                  </td>
                  <td>$25.00</td>
                ...
                <tr>
                  <td>
                    <div class="media">
                      <div class="media-left media-middle">
                        <a href="http://simpleqode.com/preview/beatrix/1.0.1/blue-grey/shopping-cart.html#">
                          <img class="media-object shopping-cart__img" src="./cart_files/product_2.jpg" alt="...">
                        </a>
                      </div>
                      <div class="media-body">
                        <a href="http://simpleqode.com/preview/beatrix/1.0.1/blue-grey/shopping-cart.html#">Beautiful Seashell from the Caribbean Sea</a>
                  ...
                  <td>
                    <form class="form-inline">
                      <div class="form-group">
                        <label for="product__quantity_2" class="sr-only">Quantity</label>
                        <input type="number" id="product__quantity_2" value="2" class="form-control shopping-cart__qty">
                      </div>
                    </form>
                  </td>
                  <td>$25.00</td>
                ...
                <tr>
                  <td>
                    <div class="media">
                      <div class="media-left media-middle">
                        <a href="http://simpleqode.com/preview/beatrix/1.0.1/blue-grey/shopping-cart.html#">
                          <img class="media-object shopping-cart__img" src="./cart_files/product_3.jpg" alt="...">
                        </a>
                      </div>
                      <div class="media-body">
                        <a href="http://simpleqode.com/preview/beatrix/1.0.1/blue-grey/shopping-cart.html#">Beautiful Seashell from the Caribbean Sea</a>
                  ...
                  <td>
                    <form class="form-inline">
                      <div class="form-group">
                        <label for="product__quantity_3" class="sr-only">Quantity</label>
                        <input type="number" id="product__quantity_3" value="3" class="form-control shopping-cart__qty">
                      </div>
                    </form>
                  </td>
                  <td>$25.00</td>
