          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li class="active"><a href="http://simpleqode.com/preview/beatrix/1.0.1/blue-grey/shop-item.html">Shop Item</a></li>
        ...
        <!-- Carousel -->
          <div id="product-item__carousel" class="carousel slide" data-ride="carousel">
            ...
            <ol class="carousel-indicators">
              ...
              <li class="" data-target="#product-item__carousel" data-slide-to="1"></li>
              <li class="" data-target="#product-item__carousel" data-slide-to="2"></li>
            </ol>
            ...
            <div class="carousel-inner" role="listbox">
              ...
              <div class="item">
                <img src="Product_files/product_3.jpg" alt="...">
                <div class="carousel-caption">
                  Image 2
                </div>
              </div>
              <div class="item">
                <img src="Product_files/product_4.jpg" alt="...">
                <div class="carousel-caption">
                  Image 3
                </div>
              </div>
...
Aenean pulvinar blandit elementum. Aliquam a velit non ex ornare 
tincidunt at eu orci. Mauris imperdiet accumsan neque, in sollicitudin 
felis. Donec convallis nulla ut lacinia cursus. Ut vitae ante risus. 
Pellentesque ut nibh non nisi posuere pretium. Mauris et neque pulvinar,
 egestas nunc nec, pretium diam.
          </p>
          <ul class="list-group">
          ...
          <div class="product__add-to-cart">
            <form class="form-inline">
              <div class="form-group">
                ...
                <p class="form-control-static"><strong>US $14,99 x</strong></p>
              </div>
              <div class="form-group">
                ...
                <div class="footer__content">
                  <div class="footer__post">
                    <div class="footer-post__img">
                      <img src="Product_files/general_1.jpg" alt="...">
                    </div>
                  ...
                  <div class="footer__post">
                    <div class="footer-post__img">
                      <img src="Product_files/general_2.jpg" alt="...">
                    </div>
                    <div class="footer-post__content">
                      <p><a href="#">Lorem ipsum dolor sit amet</a></p>
                      <time datetime="2015-01-01">2015/01/01</time>
                  ...
                  <div class="footer__post">
                    <div class="footer-post__img">
                      <img src="Product_files/general_3.jpg" alt="...">
                    </div>
                    <div class="footer-post__content">
                      <p><a href="#">Lorem ipsum dolor sit amet</a></p>
                      <time datetime="2015-01-01">2015/01/01</time>
